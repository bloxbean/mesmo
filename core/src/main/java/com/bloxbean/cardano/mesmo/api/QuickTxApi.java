 ...
 *
 * <p>See {@link com.bloxbean.cardano.mesmo.Mesmo} for the calling convention. The single entry
...
public final class QuickTxApi {
     ...
     * the lib does not guess. Undercounting yields a fee the node rejects with
