...
public final class PlutusApi {
    ...
    public static int toJson(IsolateThread thread, CCharPointer cborHexPtr) {
        try {
            ...
            String json = com.bloxbean.cardano.mesmo.util.JsonHelper.toJson(plutusData);
    ...
    public static int fromJson(IsolateThread thread, CCharPointer jsonPtr) {
        try {
            ...
            PlutusData plutusData = com.bloxbean.cardano.mesmo.util.JsonHelper.fromJson(json, PlutusData.class);
