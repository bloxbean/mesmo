...
import com.bloxbean.cardano.mesmo.util.NetworkMapper;
...
public final class AccountService {
    ...
    // cross-isolate handle collisions certain: with two instances in one process, lib A's
    // handle 1 aliased lib B's account 1, and the wrong lib/handle pairing signed with
    ...
    public static String infoJson(long handle) throws com.fasterxml.jackson.core.JsonProcessingException {
        ...
        String json = com.bloxbean.cardano.mesmo.util.JsonHelper.toJson(info(handle));
