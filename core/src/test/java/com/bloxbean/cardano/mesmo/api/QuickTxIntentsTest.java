...
/**
 * Verifies the lib builds each non-payment TxPlan intent (staking, governance, DRep, voting,
 ...
 * the lib with caller-supplied UTXOs + protocol parameters.
 */
class QuickTxIntentsTest {
    ...
    /**
     * Build a Tx through the lib (TxPlan YAML -> offline build) and assert it produced CBOR. Also
