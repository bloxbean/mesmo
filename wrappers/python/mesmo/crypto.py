...
class Crypto:
    ...
    def blake2b_256(self, data_hex):
        ...
        rc = self._b._lib.mesmo_crypto_blake2b_256(self._b._thread, self._b._encode(data_hex))
        return self._b._check(rc)

    def blake2b_224(self, data_hex):
        """Compute Blake2b-224 hash. Returns hex string."""
        rc = self._b._lib.mesmo_crypto_blake2b_224(self._b._thread, self._b._encode(data_hex))
        return self._b._check(rc)

    def generate_mnemonic(self, word_count=24):
        """Generate a new mnemonic phrase."""
        rc = self._b._lib.mesmo_crypto_generate_mnemonic(self._b._thread, word_count)
        return self._b._check(rc)
    ...
    def sign(self, message_hex, sk_hex):
        ...
        rc = self._b._lib.mesmo_crypto_sign(
    ...
    def derive_key(self, mnemonic, account_index=0, address_index=0, role="payment"):
        ...
        key bytes.
        """
        rc = self._b._lib.mesmo_crypto_derive_key(
